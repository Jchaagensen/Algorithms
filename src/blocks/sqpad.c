...
char *usage_text[] =
{
    "                                                                        ",
    "NAME                                                                    ",
    "  sqpad -  add specified number of zero bins to either side of a raster ",
    "SYNOPSIS                                                                ",
    "  sqpad [OPTIONS] ...                                                   ",
    "DESCRIPTION                                                             ",
    "  -l  Input number of samples                                           ",
    "  -o  Number of output stamples, must be > than input, coerced to even  "
};
...
int main(int argc, char *argv[])
{
    ...
    int status = sq_pad(stdin, stdout, in_length, out_length);
